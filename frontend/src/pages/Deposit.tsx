...
const TIERS = [
    { tier: 'Starter', range: '20 – 999 USDT', roi: '1.50%/day', days: '30 days', color: 'text-amber-400' },
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="flex gap-2.5 rounded-lg border border-amber-500/30 bg-amber-500/10 p-3 text-sm">
                                        ...
                                        <div className="text-amber-200/80">
                                            <strong className="text-amber-400">Important:</strong> Send only <strong>USDT BEP-20</strong> on the BSC network.
                                    ...
                                    <div className="rounded-lg border border-border bg-card p-4 space-y-3 shadow-sm">
                                        ...
                                        <form onSubmit={handleVerify} className="flex gap-2">
                                            ...
                                            />
                                            <Button type="submit" variant="gold" disabled={verifyMutation.isPending}>
