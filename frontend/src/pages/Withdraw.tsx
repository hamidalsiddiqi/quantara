            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2">
                    <Card>
                        ...
                        <CardContent>
                            {/* Balance display */}
                            <div className="mb-5 rounded-xl border border-amber-500/20 bg-gradient-to-br from-amber-950/40 to-card p-4">
                                ...
                                {balLoading ? (
                                    ...
                                    <p className="text-2xl font-bold text-gold-gradient">{formatUSDT(balanceData?.withdrawable ?? '0')}</p>
                                )}
                            </div>
