    ...
    const SidebarContent = () => (
        <div className="flex h-full flex-col">
            ...
            <div className="flex items-center gap-2.5 px-3 py-5">
                ...
                <div>
                    <span className="text-base font-bold text-gold-gradient">Quantara</span>
                    <p className="text-[10px] text-muted-foreground leading-none mt-0.5">USDT Platform</p>
                </div>
            </div>
            ...
            <div className="flex flex-1 flex-col min-w-0">
                ...
                <header className="fixed top-0 left-0 right-0 z-50 flex h-14 items-center gap-3 border-b border-border bg-background/60 backdrop-blur-md px-4 lg:hidden">
                    <div className="flex items-center gap-2">
                        <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br from-amber-400 to-amber-600 shadow-lg shadow-amber-500/20">
                            <TrendingUp className="h-4 w-4 text-black" />
                        </div>
                        <span className="font-bold text-lg text-gold-gradient tracking-tight">Quantara</span>
                    </div>
                </header>
